...
// Routes
router.post('/', verifyToken, validateQuestion, questionController.createQuestion);
...
router.put('/:id', verifyToken, validateQuestion, questionController.updateQuestion);
router.delete('/:id', verifyToken, questionController.deleteQuestion);

// Answers routes
router.post('/:questionId/answers', verifyToken, validateAnswer, answerController.createAnswer);
